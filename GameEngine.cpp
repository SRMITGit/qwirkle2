...
GameEngine::GameEngine(Player player1, Player player2) {
  ...
  // std::cout << "The size of the board  before adding tile is : " <<
  // board->getSize() << std::endl; board->setTile(0, 0, playerTile); std::cout
  // << "The size of the board after adding tile is : " << board->getSize() <<
  // std::endl;
